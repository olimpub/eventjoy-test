...
c = c.replace(
    ...
    'font-black tracking-[1.5px] text-[13px] text-sky-400 drop-shadow-md mr-2" style="-webkit-text-stroke: 0.5px currentColor; text-shadow: 0px 0px 2px currentColor;"'
)
...
c = c.replace(
    ...
    'font-black tracking-[1.5px] text-[13px] text-slate-300 drop-shadow-md mr-2" style="-webkit-text-stroke: 0.5px currentColor; text-shadow: 0px 0px 2px currentColor;"'
)
