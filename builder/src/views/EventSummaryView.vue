<template>
  ...
  >
    ...
    <div class="relative h-[120px] w-full group overflow-hidden">
      ...
      <!-- Status Badge (GREEN: Lezárt), Toggle & Profile -->
      <div class="absolute bottom-2 left-6 right-6 flex items-center justify-between gap-2 z-10">
        <span class="px-3 py-1.5 rounded-lg text-xs font-black uppercase tracking-widest shadow-lg flex items-center gap-1.5 transition-colors bg-green-500 text-white">
    ...
    <div class="px-6 mt-4 relative z-10">
      ...
      <div class="mb-6 flex justify-center">
        <button
          class="flex items-center gap-3 px-8 py-4 rounded-2xl bg-brand-cyan text-brand-dark font-black uppercase tracking-widest text-xs shadow-xl active:scale-95 transition-all hover:bg-white"
        >
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div class="grid grid-cols-2 gap-3 mb-6">
        ...
        <div class="bg-white/5 border border-white/10 rounded-[2rem] p-4 backdrop-blur-md flex items-center gap-4">
          ...
          <div class="flex flex-col">
            ...
            <span class="text-xl font-black text-white">118 e</span>
          </div>
        </div>
        ...
        <div class="bg-white/5 border border-white/10 rounded-[2rem] p-4 backdrop-blur-md flex items-center gap-4">
          ...
          <div class="flex flex-col">
            ...
            <span class="text-xl font-black text-white">8</span>
          </div>
        </div>
      </div>
      ...
      <!-- Rounds List with Results (All 3 expanded) -->
      <section class="space-y-3">
        ...
        >
          ...
          <div class="absolute top-4 right-6 flex items-center gap-2">
            ...
            <div class="px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-widest bg-green-500 text-white shadow-lg">
              Lezárt
            </div>
          </div>
...
const results = ref([
  ...
  { number: 3, status: 'lezárt', rank: '2', score: '36e', truck: '9e', isExpanded: false }
])
