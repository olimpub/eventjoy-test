 ...
 */
type CredentialCallback = (response: CredentialPopupResponse) => void;
/**
 * Callback triggered with auth code response on google login popup success.
 */
type CodeResponseCallback = (response: CodePopupResponse) => void;
/**
 * Callback triggered with access token response on google login popup success.
 */
type TokenResponseCallback = (response: TokenPopupResponse) => void;
...
type ActionOnLibraryLoad = (google: Google) => void;
/**
 ...
 */
type GoogleSdkLoaded = (action: ActionOnLibraryLoad) => void;
 ...
 */
type GoogleOneTap = (options?: OneTapOptions) => Promise<CredentialPopupResponse>;
/**
...
interface Google {
    accounts: {
        ...
        oauth2: {
            ...
            hasGrantedAnyScope: (tokenResponse: TokenPopupResponse, firstScope: string, ...restScopes: string[]) => boolean;
            hasGrantedAllScopes: (tokenResponse: TokenPopupResponse, firstScope: string, ...restScopes: string[]) => boolean;
            revoke: (accessToken: string, done?: () => void) => void;
        };
    };
}
...
type DecodeCredential = (token: string) => object;
...
declare const _default$1: vue.DefineComponent<vue.ExtractPropTypes<{
    ...
    popupType: PropType<PopupTypes | undefined>;
    /** IdConfiguration for GIS initialize */
    idConfiguration: PropType<Record<string, unknown> | undefined>;
    /** GsiButtonConfiguration for the rendered button */
    buttonConfig: PropType<Record<string, unknown> | undefined>;
    /** Success callback */
    callback: PropType<Function | undefined>;
    /** Error callback */
    error: PropType<Function | undefined>;
}>, {
    buttonRef: vue.Ref<HTMLElement | undefined, HTMLElement | undefined>;
    hasSlot: boolean;
    options: Options;
    openPopup: (type?: PopupTypes) => void;
...
//# sourceMappingURL=GoogleLogin.vue?vue&type=script&lang.d.ts.map
...
export { callbackTypes_d as CallbackTypes, _default$1 as GoogleLogin, decodeCredential, _default as default, googleAuthCodeLogin, googleLogout, googleOneTap, googleSdkLoaded, googleTokenLogin, useGoogleSdk };
